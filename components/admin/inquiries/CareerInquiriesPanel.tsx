...
export function CareerInquiriesPanel({ firebase }: CareerInquiriesPanelProps) {
  ...
  const inquiryKind: AdminInquiryKind = "career";
  ...
  const handleMarkInquiryRead = useCallback((inquiryId: string) => {
    ...
    updateDoc(firebase.userRef(userId), {
      ...
      console.error("[CareerInquiries] failed to mark inquiry read", error);
    });
  }, [firebase, inquiryKind, userId]);
  ...
  const handleMarkInquiryUnread = useCallback((inquiryId: string) => {
    ...
    updateDoc(firebase.userRef(userId), {
      ...
      console.error("[CareerInquiries] failed to mark inquiry unread", error);
    });
  }, [firebase, inquiryKind, userId]);
  ...
  const handleMarkAllViewed = useCallback(() => {
    ...
    updateDoc(firebase.userRef(userId), {
      ...
      console.error("[CareerInquiries] failed to mark all read", error);
    });
